...
const N8N_WORKFLOWS = [
  {
    ...
    jsonUrls: [
      "https://raw.githubusercontent.com/ThejRaj06/automation-systems/main/workflows/github-pr-reviewer/pr-review-workflow.json",
    ],
  },
  {
    id: 2,
    ...
    jsonUrls: [
      "https://raw.githubusercontent.com/ThejRaj06/automation-systems/main/workflows/github-pr-reviewer/vector-sync-workflow.json",
    ],
  },
  {
    id: 3,
    ...
    jsonUrls: [
      "https://raw.githubusercontent.com/ThejRaj06/automation-systems/main/workflows/telegram-truecaller-bot/workflow.json",
    ],
  },
  {
    id: 4,
    ...
    jsonUrls: [
      "https://raw.githubusercontent.com/ThejRaj06/automation-systems/main/workflows/monthly-grocery-calculator/Grocery%20Adder.json",
      "https://raw.githubusercontent.com/ThejRaj06/automation-systems/main/workflows/monthly-grocery-calculator/Monthly%20expense%20calculator.json",
      "https://raw.githubusercontent.com/ThejRaj06/automation-systems/main/workflows/monthly-grocery-calculator/Web%20scraper.json",
    ],
  },
];

const LaptopSection = ({ defaultTab = "profile" }) => {
  const [activeWorkflowViewer, setActiveWorkflowViewer] = useState(null);

  return (
    <>
      {activeWorkflowViewer && (
        <WorkflowViewer
          workflowData={{
            jsonUrls: activeWorkflowViewer.jsonUrls,
            githubLink: activeWorkflowViewer.ghLink,
          }}
          onClose={() => setActiveWorkflowViewer(null)}
        />
      )}
          ...
          <TabsContent value="workflows" className="mt-6">
            ...
            >
              {N8N_WORKFLOWS.map((workflow, index) => (
                <div
                  key={workflow.id}
                  onClick={() => setActiveWorkflowViewer(workflow)}
